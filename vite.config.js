  ...
  return {
    ...
    transform(code, id) {
      ...
      updated = updated
        ...
        .replace('<div className="mt-5 flex flex-col gap-2 sm:flex-row"><Button onClick={copyPlan} icon={Copy}>Copy Plan</Button><Button onClick={downloadPlan} variant="dark" icon={Download}>Download Plan</Button></div></Card>', '<div className="mt-5 flex flex-col gap-2 sm:flex-row"><Button onClick={copyPlan} icon={Copy}>Copy Plan</Button><Button onClick={downloadPlan} variant="dark" icon={Download}>Download Plan</Button></div><ProofActionBar setTab={setTab} /></Card>')
        .replace('<div className="space-y-5"><Card><ListBlock title="Weekly training plan" items={selectedEvent.weekly} icon={ClipboardCheck} /></Card>', '<div className="space-y-5"><PlainEnglishPlan event={selectedEvent} /><ReadinessLevels selectedEvent={selectedEvent} backupEvent={backupEvent} setTab={setTab} /><ProofPlanSection event={selectedEvent} /><PlanProcessSummary event={selectedEvent} /><Card><ListBlock title="Weekly training plan" items={selectedEvent.weekly} icon={ClipboardCheck} /></Card>')

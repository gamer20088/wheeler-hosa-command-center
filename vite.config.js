  ...
  return {
    ...
    transform(code, id) {
      ...
      updated = updated
        ...
        .replace('<div className="space-y-5"><Card><ListBlock title="Weekly training plan" items={selectedEvent.weekly} icon={ClipboardCheck} /></Card>', '<div className="space-y-5"><PlainEnglishPlan event={selectedEvent} /><ProofPlanSection event={selectedEvent} /><Card><ListBlock title="Weekly training plan" items={selectedEvent.weekly} icon={ClipboardCheck} /></Card>')
        ...
        .replace('{activeTab === \'plan\' && <MyPlan selectedEvent={selectedEvent} />}{activeTab === \'guide\'', '{activeTab === \'plan\' && <MyPlan selectedEvent={selectedEvent} />}{activeTab === \'proof\' && <ProofTracker selectedEvent={selectedEvent} />}{activeTab === \'guide\'')

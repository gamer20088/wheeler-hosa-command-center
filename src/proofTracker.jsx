...
export function ProofPlanSection({ event }) {
  return <Card><ProofList title="Weekly Proof You Should Submit" items={getProofExamples(event)} icon={ClipboardCheck} /><div className="mt-4 rounded-xl bg-teal-50 p-3 ring-1 ring-teal-100"><p className="text-xs font-black uppercase tracking-wide text-teal-700">Proof Code</p><p className="mt-1 text-lg font-black text-teal-950">{PROOF_CODE}</p><p className="mt-1 text-sm font-bold leading-6 text-teal-950">Use this code on the form so officers know the submission came from Wheeler HOSA.</p></div></Card>
}
